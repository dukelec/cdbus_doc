...
The CDBUS controller CDCTL01A comes in a 3x3mm QFN package, supports communication rates up to 50 Mbps (50,000,000 bps), connects to the host controller via SPI, operates in a temperature range from -40°C to 125°C, and is easy to get started with.
...
## Application Scenarios
 ...
 - For more complex applications, such as humanoid robots, the performance of traditional CAN and RS-485 is no longer sufficient,
 ...
 - Many servo products do not support replying to broadcast packets, so the host cannot efficiently retrieve the status of each servo on the bus.
 ...
 - Some devices using RS-232 do not lend themselves to bus connections, and communication speed and distance are limited.
   Why not switch to RS-485? Because traditional RS-485 is half-duplex, which prevents slave devices from sending data proactively,
...
## Resource List
 ...
 - CDCTL01A Datasheet, code examples: https://dukelec.com/en/download.html
